...
bot = telebot.TeleBot('1427114083:AAEPoRlpg0YTqJYdGG3HThEJdMSdv408pAE')
...
def get_text_messages(message):
    ...
    if message.text == "/start":
        ...
        bot.send_message(message.from_user.id, "Если будут вопросы напиши мне @Mukhtarxxan,УДАЧИ! (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧")
